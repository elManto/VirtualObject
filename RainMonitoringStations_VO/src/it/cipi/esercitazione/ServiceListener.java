...
public class ServiceListener implements ServletContextListener{
	...
	public void contextInitialized(ServletContextEvent evt) {
		...
		sc = evt.getServletContext();
		sc.setAttribute("URL_ORCHESTRATOR", "");	//Da inserire!
		sc.setAttribute("URL_VO_REGISTER", "http://localhost:8080/VO_Register/rest/TestService/testparam");
		...
		client = new VORealObjectCommunicationMQTT(sc);
		client.doDemo();
	}
	...
	private void sendRequest() {
		try {
			...
			URL url = new URL((String)sc.getAttribute("URL_VO_REGISTER"));
			...
			input_values.put("ip", "http://localhost:8080/RainMonitoringStations_VO/rest/VOCoreCommunication/invokeAction");
